              ...
              <div class="row"> 
                <div class="col-xs-12">
                  <ul class="list-unstyled list-inline">
                    ...
                    <li class="filter" data-filter=".logo">Logo Design</li>
                ...
                <div class="gallery">
                  <div class="col-xs-6 col-sm-6 col-md-3">
                    <div class="mix web">
                      <div class="overlay">
                        <div class="show-work"> 
                          <h5>Project Name</h5><span>Web Design</span>
                        </div>
                      </div><img src="<?php echo get_template_directory_uri().'/images/portfolio/image_1.jpg'?>" alt="web-design">
                    </div>
                  ...
                  <div class="col-xs-6 col-sm-6 col-md-3">
                    <div class="mix web">
                      ...
                      </div><img src="<?php echo get_template_directory_uri().'/images/portfolio/image_2.jpg'?>" alt="web-design">
                    </div>
                    <div class="view-project"></div>
                  </div>
                  <div class="col-xs-6 col-sm-6 col-md-3">
                    <div class="mix web">
                      ...
                      </div><img src="<?php echo get_template_directory_uri().'/images/portfolio/image_3.jpg'?>" alt="web-design">
                    </div>
                    <div class="view-project"></div>
                  </div>
                  <div class="col-xs-6 col-sm-6 col-md-3">
                    <div class="mix web">
                      ...
                      </div><img src="<?php echo get_template_directory_uri().'/images/portfolio/image_4.jpg'?>" alt="web-design">
                    </div>
                    <div class="view-project"></div>
                  </div>
                  <div class="col-xs-6 col-sm-6 col-md-3">
                    <div class="mix graphic">
                      <div class="overlay">
                        <div class="show-work"> 
                          <h5>Project Name</h5><span>Graphic Design</span>
                        </div>
                      </div><img src="<?php echo get_template_directory_uri().'/images/portfolio/image_5.jpg'?>" alt="graphic-design">
                    </div>
                    <div class="view-project"></div>
                  </div>
                  <div class="col-xs-6 col-sm-6 col-md-3">
                    <div class="mix graphic">
                      ...
                      </div><img src="images/portfolio/image_6.jpg" alt="graphic-design">
                    </div>
                    <div class="view-project"></div>
                  </div>
                  <div class="col-xs-6 col-sm-6 col-md-3">
                    <div class="mix graphic">
                      ...
                      </div><img src="images/portfolio/image_7.jpg" alt="graphic-design">
                    </div>
                    <div class="view-project"></div>
                  </div>
                  <div class="col-xs-6 col-sm-6 col-md-3">
                    <div class="mix graphic">
                      ...
                      </div><img src="images/portfolio/image_8.jpg" alt="graphic-design">
                    </div>
                    <div class="view-project">             </div>
                  </div>
                  <div class="col-xs-6 col-sm-6 col-md-3">
                    <div class="mix mobile">
                      <div class="overlay">
                        <div class="show-work"> 
                          <h5>Project Name</h5><span>Mobile Applications</span>
                        </div>
                      </div><img src="images/portfolio/image_9.jpg" alt="mobile-app">
                    </div>
                    <div class="view-project"></div>
                  </div>
                  <div class="col-xs-6 col-sm-6 col-md-3">
                    <div class="mix mobile">
                      ...
                      </div><img src="images/portfolio/image_10.jpg" alt="mobile-app">
                    </div>
                    <div class="view-project"></div>
                  </div>
                  <div class="col-xs-6 col-sm-6 col-md-3">
                    <div class="mix mobile">
                      ...
                      </div><img src="images/portfolio/image_11.jpg" alt="mobile-app">
                    </div>
                    <div class="view-project"></div>
                  </div>
                  <div class="col-xs-6 col-sm-6 col-md-3">
                    <div class="mix mobile">
                      ...
                      </div><img src="images/portfolio/image_12.jpg" alt="mobile-app">
                    </div>
                    <div class="view-project">       </div>
                  </div>
                </div>
