...
//
//        $title = sprintf('<a href="?page=%s&action=%s&id=%s">%s</a>',$_REQUEST['page'],'edit',$item['id'],$item['title']);
//
//        //Build row actions
//        $actions = array(
...
//            $typeDisplay = '';
//            switch($type) {
//                case CRPGridType::TEAM:
//                    $typeDisplay = 'Team';
//                    break;
//                case CRPGridType::CLIENT_LOGOS:
//                    $typeDisplay = 'Client Logos';
//                    break;
//                case CRPGridType::ALBUM:
//                    $typeDisplay = 'Album';
//                    break;
//                case CRPGridType::GALLERY:
//                    $typeDisplay = 'Gallery';
//                    break;
//                case CRPGridType::CATALOG:
//                    $typeDisplay = 'Catalog';
//                    break;
//
//            }
//            $results[$i]["type_display"] = $typeDisplay;

            //Build row actions
            $actions = array(
                'options'   => sprintf('<a href="?page=%s&action=%s&id=%s" class="crp-settings-btn" style="float: left; margin-right: 7px;"><i class="fa fa-cog fa-fw" style="font-size: 14px; padding: 5px 0 0 3px;"></i></a>',$_REQUEST['page'],'options',$pid),
                'edit'      => sprintf('<a href="?page=%s&action=%s&id=%s&type=%s" class="crp-edit-btn" style="float: left; margin-right: 7px;"><i class="fa fa-pencil" style="font-size: 14px; padding: 5px 0 0 6px;"></i></a>',$_REQUEST['page'],'edit',$pid, $type),
                'delete'    => sprintf('<a href="?page=%s&action=%s&id=%s" class="crp-delete-btn" onclick="if(!confirm(\'Are you sure you want to delete the portfolio?\')) return false;" style="float: left; margin-right: 7px; margin-top: 0px;"><i class="fa fa-minus" style="font-size: 14px;padding: 6px 0 0 6px"></i></a>',$_REQUEST['page'],'delete',$pid),
